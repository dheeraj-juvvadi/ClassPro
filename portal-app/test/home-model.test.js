...
test('insights distinguish positive, zero and required attendance hours', () => {
  assert.equal(classproHomeModel.insight({ present: 18, conducted: 22 }).margin, '2 margin');
  assert.equal(classproHomeModel.insight({ present: 13, conducted: 19 }).margin, '-5 margin');
